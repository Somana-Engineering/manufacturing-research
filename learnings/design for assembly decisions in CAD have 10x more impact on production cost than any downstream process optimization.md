...
The BOM specification research quantifies specific DFA trade-offs for the boarding box: [[heat-set insert count is a critical DFA lever where reducing inserts from 8-12 to 4 saves 32 to 48 seconds in manual mode|reducing heat-set inserts from 8-12 to 4]] saves 32-48s manual time; [[keyed connectors trade pennies in BOM cost for seconds of cycle time and near-elimination of polarity assembly errors|keyed connectors]] save 30-48s per unit at $0.90-3.00 BOM increase; [[SBC carrier boards add 5 to 15 dollars BOM cost but reduce station 2 cycle time by 15 to 20 seconds and eliminate the most common assembly error|carrier boards]] save 15-20s and eliminate bent GPIO pins for $5-15. Combined, these DFA interventions save 77-116s per unit in Manual mode — confirming the 10x multiplier in concrete terms.
...
- [[heat-set insert count is a critical DFA lever where reducing inserts from 8-12 to 4 saves 32 to 48 seconds in manual mode]] — quantified DFA intervention: insert reduction
- [[keyed connectors trade pennies in BOM cost for seconds of cycle time and near-elimination of polarity assembly errors]] — quantified DFA intervention: connector selection
- [[SBC carrier boards add 5 to 15 dollars BOM cost but reduce station 2 cycle time by 15 to 20 seconds and eliminate the most common assembly error]] — quantified DFA intervention: carrier board
- [[BOM cost versus assembly cycle time creates a spectrum of trade-offs where every dollar spent on poka-yoke components saves seconds on the line]] — the spectrum of DFA trade-offs
